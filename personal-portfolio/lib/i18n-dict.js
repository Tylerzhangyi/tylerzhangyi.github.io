export const dict = {
  zh: {
    ...
    tbi: {
      ...
      line2: 'Built with Next.js, inspired by Form Studio.',
      discover: 'Contact',
      email: 'Email',
      github: 'GitHub'
    },
    links: {
      ...
      visit: '访问链接 →',
      kicker: '精选链接',
      tbiLine1: 'This site was designed by Favorit x Frame',
      tbiLine2: 'exclusive for The Brand Identity.',
      dragHint: '拖拽卡片可自由摆放',
      scanHint: '拖动扫描环带',
      enter: '进入航道',
      sector: '航道',
    ...
    contact: {
      ...
      colCollaborate: '合作',
      colExplore: '浏览',
      email: 'Tyler.zhang.cn@hotmail.com',
      github: 'GitHub',
      location: '所在地',
      gameAccount: 'QQ',
      sendMail: '发邮件',
  ...
  en: {
    ...
    about: {
      ...
      hobbies: 'Hobbies',
      hobbiesList: ['Sketching', 'Oil Painting', 'Video Games', 'Baseball'],
    ...
    skills: {
      ...
      educationList: [
        ...
        {
          degree: 'Engineering School Admission',
          institution: 'Washington University in St. Louis (WashU)',
          period: '2026',
          description: 'Admitted to the WashU School of Engineering this year.'
        }
      ],
      coursesList: [
        'CL/AP Computer Science A',
    ...
    projects: {
      ...
      statusDocumented: 'Archived',
      featured: 'Primary Mission',
      demo: 'Demo',
      demoUplink: 'Demo Uplink',
      sourceUplink: 'Source Uplink',
      visit: 'Visit repo →',
      ...
      missionRegistry: 'Mission Registry',
      activeMission: 'Active Mission',
      systemModules: 'System Modules',
      selectMission: 'Select mission',
      live: 'Live',
      sequence: 'Seq',
      moduleStack: 'Module Stack',
      operationalStatus: 'Operational Status',
      uplinkChannels: 'Uplink Channels',
      noUplink: 'No external uplink',
    ...
    blog: {
      title: 'Blog',
      kicker: 'Editorial',
      subtitle: 'Curated writing · selected for the gallery',
      featured: 'Cover Story',
      collection: 'In This Issue',
      issue: 'Issue',
      readingTime: 'Read',
    ...
    links: {
      ...
      tbiLine1: 'This site was designed by Favorit x Frame',
      tbiLine2: 'exclusive for The Brand Identity.',
      dragHint: 'Drag cards to rearrange',
      scanHint: 'Drag to scan the ring',
      enter: 'Enter gateway',
      sector: 'Sector',
      linksList: [
        {
